...
- Skill(s): ids from graph SKL rows or `metadata.related_skills`; `none` via `order: []`  
...
*Analysis and Why: short phrases only. Do not paste the user message.*
