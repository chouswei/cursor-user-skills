...
| analytical-mechanics-propose | P | user | medium | medium | structural | low |
...
| clickup-project-management | P | user | medium | medium | structural | low |
...
| d2-pid | T | user | medium | medium | structural | low |
| decision-inverter | R | user | high | high | conceptual | high |
| diagram-routing | P | user | medium | medium | structural | low |
...
| ggiles | T | user | medium | medium | structural | low |
| github-wiki-writer | P | user | medium | medium | structural | low |
...
| overleaf-free-cloud-olcli-mcp | G | user | medium | medium | structural | low |
| overleaf-session-cookie-refresh | G | user | medium | medium | structural | low |
...
| physics-constrained-surrogate-routing | P | user | medium | medium | structural | low |
| physics-enforce-constrained-nn | P | user | medium | medium | structural | low |
| physics-kan-global-opt | P | user | medium | medium | structural | low |
| physics-relu-milp-embed | P | user | medium | medium | structural | low |
...
| pydexpi-p-id | P | user | medium | medium | structural | low |
