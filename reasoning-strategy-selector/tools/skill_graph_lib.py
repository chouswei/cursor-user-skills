...
FEATURE_MAP: Dict[str, Tuple[str, str, str, str, str, str]] = {
    ...
    "mcp-sysmledge": ("T", "sysml", "medium", "medium", "structural", "low"),
...
MANUAL_PRECEDES = [
    ...
    ("mcp-sysmledge", "sysmledge-workflow"),
...
MANUAL_COMPLEMENTS = [
    ...
    ("sysmledge-cursor-multitask", "mcp-sysmledge"),
...
KEYWORD_DIRECT: List[Tuple[List[str], str, float]] = [
    ...
    (["sysmledge", "cursor", "multitask"], "sysmledge-cursor-multitask", 2.4),
    (["tip!=face"], "sysmledge-cursor-multitask", 2.4),
    (["sysmledge", "multitask"], "sysmledge-cursor-multitask", 2.2),
    (["mcp-sysmledge"], "mcp-sysmledge", 2.4),
    (["sysmledge", "product", "face"], "mcp-sysmledge", 2.3),
