...
**Authority:** [sysml-memnet-cache](../../sysml-memnet-cache/SKILL.md). Specialist skills **write** these tags after `mcp-sysml-v2` validate; **read** via `query_warm(TSK_model_<short>)`.
