...
**Package 0.19.1** (extras 0.10-0.19 unchanged). **PyPI wheel** still **0.19.0** until twine. **1.0** unclaimed (claim of 0.5-0.8). Chat is **never** mission SSOT.
...
## Shipped vs still design (package 0.19.1)
