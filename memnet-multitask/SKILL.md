...
**Package and PyPI 0.19.5** (honesty `c` on 0.19 -- not a usage-method `b`; extras 0.10-0.19 unchanged). **1.0** unclaimed (claim of 0.5-0.8). No 0.20. Chat is **never** mission SSOT.
