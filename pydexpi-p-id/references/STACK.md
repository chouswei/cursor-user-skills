...
```bash
python3 -m venv /workspace/venv-pi-pid
/workspace/venv-pi-pid/bin/pip install pydexpi SFILES2 ggiles
```
...
Graph/SFILES/GGILES → ports/items/connections via skill `sfiles-pydexpi-sysml-bridge` (no invent equipment; `.sysml` SSOT).
