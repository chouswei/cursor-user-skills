...
How to **use** a session stack. Pair with [memnet-use](../memnet-use/SKILL.md). Doctrine: MemNet `docs/grammar/memnet-session-strata.md`. SysML loop: MemNet `docs/application-notes/llm-sysml-v2-modeling.md`. Evidence: MemNet `sysml-models/outputs/sysml-session-nest-cuts-case-study.md` (Turns A-I).
