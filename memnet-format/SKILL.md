...
**Package 0.19.1** (tag `v0.19.1`; extras 0.10-0.19 unchanged). **PyPI wheel** still **`memnet-llm==0.19.0`** until twine. **Install:** `pip install memnet-llm==0.19.0` **or** git / `v0.19.1`. Do **not** `pip install memnet-llm==0.19.1`. **1.0** unclaimed.
...
- Claim **1.0**. Teach `pip install memnet-llm==0.19.1` as the current wheel.
