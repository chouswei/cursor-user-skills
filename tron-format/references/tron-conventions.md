...
**Audience:** These rules target **LLM** readers (skills, handoffs, agent context), not print-only human manuals.
...
- **Mermaid diagram placement** (serve down): TRON `DiagramPlan` — see [mermaid-placement-by-degree.md](../../mermaid/references/mermaid-placement-by-degree.md) and [tron-format/SKILL.md](../SKILL.md).
