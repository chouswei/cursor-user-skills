---
name: sysml-v2-release-how-to-use
description: >-
  How to use the official OMG SysML-v2-Release repo: clone/submodule, normative library paths under
  libs/omg, specs and examples, optional Eclipse/Jupyter/API. Triggers: SysML-v2-Release, submodule,
  Base.kerml, ScalarValues, ISQ/SI libraries, OMG release zip, normative library setup.
metadata:
  pattern: pipeline
  domain: sysml-v2
