...
SSOT: MemNet `parts/memnet-mcp/software/memnet_mcp/server.py`. **Package 0.19.1** (PyPI wheel still **0.19.0** until twine). Wire: [memnet-format](../../memnet-format/SKILL.md); MemNet `docs/grammar/gql-wire-profile.md`.
