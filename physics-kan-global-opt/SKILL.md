...
- Default ReLU stack already suffices -- prefer [physics-relu-milp-embed](sand-workflow:physics-relu-milp-embed) (usually simpler MILP).
- Hard physics equalities at **train** time -- ENFORCE first ([physics-enforce-constrained-nn](sand-workflow:physics-enforce-constrained-nn)), optimise later if needed.
