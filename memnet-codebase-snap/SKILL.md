...
Pair with [memnet-format](../memnet-format/SKILL.md) and [mcp-memnet](../mcp-memnet/SKILL.md). Wire: MemNet `docs/grammar/gql-wire-profile.md`. **Package 0.19.1**; PyPI wheel still **0.19.0** until twine.
