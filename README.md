...
- MemNet agent I/O: **GQL wire** only (`memnet-format` + `mcp-memnet`; shaped pin_map + openCypher-shaped mutate). Do not teach pipe `@TAG` rows or Layer line dialect as agent format. SysML bridge: `sysml-gql`.
